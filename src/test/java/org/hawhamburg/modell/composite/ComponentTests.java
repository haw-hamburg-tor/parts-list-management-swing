package org.hawhamburg.modell.composite;
...
public class ComponentTests {
    ...
    public void addPartReflexiveCycle() {
        ...
        // Act & Assert
        assertThrows(CyclicStructureException.class, () -> p1.addPart(p1));
    }
    ...
    public void addPartDirectCycle() throws CyclicStructureException {
        ...
        // Act & Assert
        assertThrows(CyclicStructureException.class, () -> p2.addPart(p1));
    }
    ...
    public void addPartTransitiveCycle() throws CyclicStructureException {
        ...
        // Act & Assert
        assertThrows(CyclicStructureException.class, () -> p3.addPart(p1));
    }
}
